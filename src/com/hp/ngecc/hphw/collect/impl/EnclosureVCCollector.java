 ...
 * @version 1.0
 */
public class EnclosureVCCollector extends Collector{
 


	public EnclosureVCCollector(String name) {
		super(name,DeviceType.ENCLOSURE_VC);
	}
